...
5. Simflex output files will be located in: `/data/output/Nuclide-name/`
Than use this value as a path to your folder with all information:  
![volumes name and folders](/docs/volume_location.png)
5. Delete container, all data will be lost: `docker rm simflex`  
